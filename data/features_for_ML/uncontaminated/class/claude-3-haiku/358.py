...
class QuantizationConfig:
    ...
    def __init__(self,
                 ...
                 qdq_op_type_per_channel_support_to_axis: Dict[str, int] = None):
        ...
        self.operators_to_quantize = operators_to_quantize or []
        self.qdq_add_pair_to_weight = qdq_add_pair_to_weight
        self.qdq_dedicated_pair = qdq_dedicated_pair
        self.qdq_op_type_per_channel_support_to_axis = qdq_op_type_per_channel_support_to_axis or {}

    @staticmethod
    def quantization_type_str(activations_dtype: QuantType, weights_dtype: QuantType) -> str:
        return f"{activations_dtype.value}_{weights_dtype.value}"
    ...
    def __str__(self):
        return (
            f"QuantizationConfig(is_static={self.is_static}, "
            f"format={self.format.value}, "
            f"mode={self.mode.value}, "
            f"activations_dtype={self.activations_dtype.value}, "
            f"activations_symmetric={self.activations_symmetric}, "
            f"weights_dtype={self.weights_dtype.value}, "
