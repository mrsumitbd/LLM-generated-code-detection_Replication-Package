class GpuAllocationInternal:
    ...
    def from_rust(cls, rust_gpu_allocation: 'rust.GpuAllocation') -> 'GpuAllocationInternal':
        return cls(offset=rust_gpu_allocation.offset, used_fraction=rust_gpu_allocation.used_fraction)

    def to_rust(self) -> 'rust.GpuAllocation':
        return rust.GpuAllocation(offset=self.offset, used_fraction=self.used_fraction)